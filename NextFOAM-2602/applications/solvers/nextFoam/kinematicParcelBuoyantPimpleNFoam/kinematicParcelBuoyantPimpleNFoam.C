...
int main(int argc, char *argv[])
{
    ...
    #include "createRhoUfIfDynamic.H"
    ...
    while (runTime.run())
    {
        ...
        while (pvCoupling.loop())
        {
            if (pvCoupling.firstIter() || moveMeshOuterCorrectors)
            {
                ...
                fvc::createOldPhiPtr(phi, rho.name(), U);
            }
            ...
            fvc::makeRelative(phi, rhof, rho.name(), U);
            ...
            fvc::makeAbsolute(phi, rhof, rho.name(), U);
        }
