...
:
    ...
    UName_("U"),
    rhoName_("rho"),
    psiName_(IOobject::scopedName("thermo", "psi")),
    muName_(IOobject::scopedName("thermo", "mu")),
...
:
    ...
    psiName_
    (
        dict.getOrDefault<word>("psi", IOobject::scopedName("thermo", "psi"))
    ),
    muName_
    (
        dict.getOrDefault<word>("mu", IOobject::scopedName("thermo", "mu"))
    ),
...
void Foam::smoluchowskiJumpTFvPatchScalarField::write(Ostream& os) const
{
    ...
    (
        "psi",
        IOobject::scopedName("thermo", "psi"),
        psiName_
    );
