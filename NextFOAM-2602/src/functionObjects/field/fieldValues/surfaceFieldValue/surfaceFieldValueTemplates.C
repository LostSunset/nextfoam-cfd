    ...
    switch (operation_)
    {
        ...
        case opAbsWeightedSum:
        {
            if (is_weightedOp() && canWeight(weightField))
            {
                ...
                (
                    weightingFactor(weightField, Sf, is_magOp(), inverseWeight_)
                );
        ...
        case opAbsWeightedUniformity:
        {
            if (is_weightedOp() && canWeight(weightField))
            {
                ...
                (
                    values,
                    Sf,
                    weightingFactor(weightField, is_magOp(), inverseWeight_)
                );
            }
