...
Foam::vector Foam::functionObjects::forces::pressureForce() const
{
    return sumPatchForcesP_;
}


Foam::vector Foam::functionObjects::forces::viscousForce() const
{
    return sumPatchForcesV_;
}


Foam::vector Foam::functionObjects::forces::internalForce() const
{
    return sumInternalForces_;
}


Foam::vector Foam::functionObjects::forces::pressureMoment() const
{
    return sumPatchMomentsP_;
}


Foam::vector Foam::functionObjects::forces::viscousMoment() const
{
    return sumPatchMomentsV_;
}


Foam::vector Foam::functionObjects::forces::internalMoment() const
{
    return sumInternalMoments_;
}
