...
)
{
    ...
    for (const IOobject& io : fieldObjects)
    {
        if (io.isHeaderClass<fieldType>())
        {
            ...
            {
                tmp<GeometricField<Type, pointPatchField, pointMesh>> trcF
                (
                    reconstructPointField<Type>(io)
                );
                GeometricField<Type, pointPatchField, pointMesh>& rcF =
                    trcF.ref();
            ...
            //reconstructPointField<Type>(io)().write(); // by Gill
            ++nReconstructed_;
        }
    }
